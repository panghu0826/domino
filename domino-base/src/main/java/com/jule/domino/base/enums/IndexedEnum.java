...
import com.jule.core.utils.Assert;
    ...
    class IndexedEnumUtil {
        ...
        public static <E extends IndexedEnum> List<E> toIndexes(E[] enums) {
            ...
            if (maxIndex >= WORNNING_MAX_INDEX) {
                LoggerUtils.coreLogger.warn(String.format("警告：枚举类%s中有索引超过%d的索引，如果有很多索引空缺，可能会造成空间浪费", enums.getClass()
