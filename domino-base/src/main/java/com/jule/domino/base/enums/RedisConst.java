...
public enum RedisConst {
    ...
    /**游戏服活跃状态0:活跃1:error*/
    GAME_LOAD_USERS_SWITCH(106,"GAME_LOAD_USERS_SWITCH_KEY","GAME_LOAD_USERS_SWITCH_VAL"),
    ...
    /**大厅平台token*/
    USER_PLATFORM_TOKEN(37,"USER_PLATFORM_TOKEN_","USER_PLATFORM_TOKEN_"),

    //总杀量池(Z)
    GAME_KILL_AMOUNT_POOL(107,"GAME_KILL_AMOUNT_POOL_KEY","GAME_KILL_AMOUNT_POOL_VAL"),
    //当前资金池量原值量
    ROBOT_POOL_CURRENT_MONEY(108,"ROBOT_POOL_CURRENT_MONEY_KEY",""),
    ROBOT_POOL_MONEY(109,"ROBOT_POOL_MONEY_KEY",""),
    //机器人数加入百分比
    ROBOT_JOIN_PCT(110,"ROBOT_JOIN_PCT_KEY",""),
    //杀量池初始值
    ROBOT_INIT_KILL_POOL(111,"ROBOT_INIT_KILL_POOL",""),
    //机器人池初始值
    ROBOT_INIT_ROBOT_POOL(112,"ROBOT_INIT_ROBOT_POOL",""),
