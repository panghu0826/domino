...
public class DealCardForTable {
    ...
    public DealCardForTable(RoomTableRelationModel roomTableRalation, String gameOrderId) {
        ...
        arrCards = WashCard.getAllCard(1);
    }

    //playType就是消息头里的gameId
    public DealCardForTable(int playType) {
        arrCards = WashCard.getAllCard(playType);
    }
     ...
     * @return
     */
    public int[] hair_card(int cardCount) {
        //获得不重复的3张手牌
