...
public class LeaveTableLogic {
     ...
     * @param table
     */
    public void logic(PlayerInfo player, AbstractTable table) {
        boolean isSuccStandUp = table.standUp(player.getSeatNum(), player.getPlayerId(), "LeaveTableLogic-logic");
        ...
        log.info("本次离开桌子玩家的信息：{}", player.toSitDownString());
        //清除player信息
